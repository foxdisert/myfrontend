          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <p className="text-gray-700 mb-6">
                These Terms of Service ("Terms") govern your use of Domain Toolkit ("Service," "we," "our," or "us") 
                and constitute a legally binding agreement between you and Domain Toolkit. By accessing or using our 
                Service, you agree to be bound by these Terms.
              </p>

              <h2 className="text-2xl font-bold text-gray-900 mb-4">Acceptance of Terms</h2>
              <p className="text-gray-700 mb-4">
                By accessing and using Domain Toolkit, you accept and agree to be bound by the terms 
                and provisions of this agreement. If you do not agree to these Terms, you must not use our Service.
              </p>

              <h2 className="text-2xl font-bold text-gray-900 mb-4">Description of Service</h2>
              <p className="text-gray-700 mb-4">
                Domain Toolkit provides domain management tools and services, including but not limited to:
              </p>
              <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
                <li>Domain availability checking</li>
                <li>Domain name suggestions and generation</li>
                <li>Domain value estimation and appraisal</li>
                <li>Domain combination tools</li>
              ...
              <p className="text-gray-700 mb-4">
                The Service and its original content, features, and functionality are owned by Domain Toolkit and are 
              ...
              <p className="text-gray-700 mb-4">
                ...
                distribute your content in connection with providing the Service.
              </p>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">Third-Party Content</h3>
              <p className="text-gray-700 mb-4">
                Our Service may contain content from third parties, including domain availability data from GoDaddy API. 
                We are not responsible for the accuracy or reliability of such third-party content.
              </p>

              <h2 className="text-2xl font-bold text-gray-900 mb-4">Advertising and Third-Party Services</h2>
              <p className="text-gray-700 mb-4">
                Our Service may display advertisements from third-party advertising networks, including Google AdSense. 
                These advertisements may use cookies and tracking technologies to provide personalized content.
              </p>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">AdSense and Advertising</h3>
              <p className="text-gray-700 mb-4">
                We use Google AdSense to display relevant advertisements. By using our Service, you acknowledge that:
              </p>
              <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
                <li>Google may use cookies to personalize ads</li>
                <li>You may see advertisements based on your browsing history</li>
              ...
              <p className="text-gray-700 mb-4">
                To the maximum extent permitted by law, Domain Toolkit shall not be liable for any indirect, incidental, 
                special, consequential, or punitive damages, including but not limited to:
              </p>
              <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
                <li>Loss of profits, data, or business opportunities</li>
                <li>Service interruptions or technical issues</li>
                <li>Errors in domain availability information</li>
              ...
              <p className="text-gray-700 mb-4">
                The Service is provided on an "as is" and "as available" basis. Domain Toolkit makes no warranties, 
                expressed or implied, including but not limited to:
              </p>
              <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
                <li>Warranties of merchantability or fitness for a particular purpose</li>
                <li>Warranties that the Service will be uninterrupted or error-free</li>
                <li>Warranties regarding the accuracy of domain information</li>
                <li>Warranties that defects will be corrected</li>
              </ul>

              <h2 className="text-2xl font-bold text-gray-900 mb-4">Indemnification</h2>
              <p className="text-gray-700 mb-4">
                You agree to indemnify and hold harmless Domain Toolkit from any claims, damages, losses, or expenses 
              ...
              <p className="text-gray-700 mb-4">
                ...
                Domain Toolkit operates. Any disputes arising from these Terms shall be resolved through binding arbitration 
                or in the appropriate courts of that jurisdiction.
              </p>
              ...
              <p className="text-gray-700 mb-4">
                These Terms constitute the entire agreement between you and Domain Toolkit regarding the Service and 
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-4">
                ...
                <p className="text-gray-700 mb-2">
                  <strong>Address:</strong> Legal Department, Domain Toolkit
                </p>
