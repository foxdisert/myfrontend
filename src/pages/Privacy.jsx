          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <p className="text-gray-700 mb-6">
                Domain Toolkit ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
              </p>
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
                ...
                <li>Domain search queries and preferences</li>
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
                <li>Provide, maintain, and improve our domain management services</li>
                <li>Process your domain availability checks and suggestions</li>
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
                ...
                <li><strong>GoDaddy API:</strong> For domain availability checking and pricing</li>
                <li><strong>Social Media Platforms:</strong> For social sharing and engagement</li>
              </ul>

              <p className="text-gray-700 mb-4">
                These third-party services may collect information about your visits and use cookies for advertising purposes. You can opt out of personalized advertising through your browser settings or by visiting the Network Advertising Initiative website.
              </p>
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
                ...
                <li>Malicious attacks or security breaches</li>
              </ul>
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-4">
                ...
                <p className="text-gray-700 mb-2">
                  <strong>Address:</strong> Privacy Officer, Domain Toolkit
                </p>
